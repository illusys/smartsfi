        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-12 footer-contact-item">
            <div className="contact-info d-flex">
              ...
              <div className="text">
                <h5>Address</h5>
                <h6>Suite 316 (3rd Floor) King's Plaza,
      ...
      <div className="footer-copyright">
        <div className="col-lg-12">
          <div className="copyright-text text-center">
            <p>© 2025 SSFI. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="footer-widget footer-nav-widget mb-40 wow fadeInUp">
        ...
        <div className="footer-widget-nav">
          <ul>
            ...
            <li>
              <a href="/services">Training & Education
</a>
            </li>
            <li>
              <a href="/services">Farm Management
</a>
            </li>
            <li>
              <a href="/services">Market Access & Support

</a>
            </li>
            <li>
              <a href="/services">Supply Chain Services</a>
            </li>
          </ul>
